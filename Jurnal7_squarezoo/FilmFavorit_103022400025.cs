...
namespace Jurnal7_squarezoo
{
    internal class FilmFavorit_103022400025
    {
        ...
        public void readJSON()
        {
            ...
            Console.WriteLine($" - Year: {filmFavorit_103022400025.year}");
            Console.WriteLine($" - Genre: {filmFavorit_103022400025.genre}");
            Console.WriteLine($" - Rating: {filmFavorit_103022400025.rating}");
            Console.WriteLine($" - Duration: {filmFavorit_103022400025.durationMinutes}");
            Console.WriteLine($" - Is Watched: {filmFavorit_103022400025.isWatched}");
        }
    }
}
